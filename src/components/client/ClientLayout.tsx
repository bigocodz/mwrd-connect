...
import { LayoutDashboard, ShoppingBag, FileText, Receipt, Wallet, LogOut } from "lucide-react";
import NotificationBell from "@/components/NotificationBell";

const navItems = [
  { label: "Dashboard", href: "/client/dashboard", icon: LayoutDashboard },
  { label: "Product Catalog", href: "/client/catalog", icon: ShoppingBag },
  { label: "My RFQs", href: "/client/rfqs", icon: FileText },
    ...
    <div className="min-h-screen bg-background flex">
      ...
      <aside className="w-64 border-r border-border bg-card flex flex-col shrink-0 sticky top-0 h-screen">
        <div className="p-4 border-b border-border">
          ...
          <span className="text-xs bg-accent text-accent-foreground px-2 py-0.5 rounded-full mt-2 inline-block">Client Portal</span>
        </div>
